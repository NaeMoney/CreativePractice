...
///////////////////////////////////////
    ...
    private IEnumerator BossLoop_Buff(){
        ...
        if(stages.randomize){
            ...
            curStage = Random.Range(0, stages.stagesSettings.Count) + 1;
        ...
        for(int s = 0; s < tempSpawnCount; s++) {
            ...
            if(s < tempSpawnCount - 1){
                ...
                if(stages.stagesSettings[curStage - 1].spawnPrefabs.Count > 0){
                    ...
                    randomPrefab = Random.Range(0, stages.stagesSettings[curStage - 1].spawnPrefabs.Count);
                ...
                if(stages.stagesSettings[curStage - 1].spawnTrans.Count > 0){
                    ...
                    randomTrans = Random.Range(0, stages.stagesSettings[curStage - 1].spawnTrans.Count);
