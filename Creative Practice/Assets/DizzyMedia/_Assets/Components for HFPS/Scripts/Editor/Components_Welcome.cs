...
namespace DizzyMedia.Welcome {
    ...
    ///////////////////////////////////////
        ...
        private string pack_Integ_DialSys = "CompForHFPS_Integ_DialSys";
    ...
    ///////////////////////////////////////
        ...
        [MenuItem("Tools/Dizzy Media/Components for HFPS/Tutorials", false , 13)]
        ...
        [MenuItem("Tools/Dizzy Media/Components for HFPS/Review Asset", false , 13)]
        ...
        [MenuItem("Tools/Dizzy Media/Components for HFPS/Components Welcome", false , 12)]
                ...
                //verNumb == "Unknown"
                    ...
                    if(componentsTabs == 2){
                        ...
                        if(integrationTabs == 1){
                            ...
                            dialSysTab = GUILayout.Toggle(dialSysTab, dmMenusLocData.dictionary[menusLocDataSlot].menuLoc.localization.languages[(int)language].windows[0].sections[3].buttons[0].local, GUI.skin.button);
                        ...
                        if(dialSysTab){
                            ...
                            if(GUILayout.Button("Import Dialogue System Pack")) {
                                ...
                                Import_Pack(pack_Integ_DialSys);
