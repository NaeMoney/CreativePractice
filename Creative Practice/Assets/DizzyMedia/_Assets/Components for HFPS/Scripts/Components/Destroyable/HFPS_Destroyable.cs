                        ...
                        for(int i = 0; i < breakStages[curStage - 1].show.Count; ++i ) {
                            ...
                            if(breakStages[curStage - 1].addForce){
                                ...
                                if(breakStages[curStage - 1].forceType == ForceType.Regular){
                                    ...
                                    breakStages[curStage - 1].rigids[i].AddRelativeTorque(Vector3.forward * -breakStages[curStage - 1].rotateForce * Random.Range(-5f, 5f));
                                    breakStages[curStage - 1].rigids[i].AddRelativeTorque(Vector3.right * - breakStages[curStage - 1].rotateForce * Random.Range(-5f, 5f));
    ...
    ///////////////////////////////////////
        ...
        public void LibraryPlay_Sound(int slot){
            ...
            if(soundLibrary[slot - 1].clips.Count > 0){
                ...
                tempSound = Random.Range(0, soundLibrary[slot - 1].clips.Count);
