...
namespace DizzyMedia.HFPS_Components {
    ...
    ///////////////////////////////////////
        ...
        public void Notifs_ValuesSet(){

            if(notifications.Count > 0){

                for(int i = 0; i < notifications.Count; i++) {

                    if(notifications[i].holder != null){

                        notifications[i].holder.SetActive(false);

                    }//holder != null

                    if(notifications[i].texts.Count > 0){

                        for(int t = 0; t < notifications[i].texts.Count; t++) {

                            if(notifications[i].texts[t].customText){

                                if(notifications[i].texts[t].text != null){

                                    if(notifications[i].texts[t].notification != ""){

                                        notifications[i].texts[t].text.text = notifications[i].texts[t].notification;

                                    }//notification != ""

                                }//text != null

                                if(notifications[i].texts[t].textMeshPro != null){

                                    if(notifications[i].texts[t].notification != ""){

                                        notifications[i].texts[t].textMeshPro.text = notifications[i].texts[t].notification;
                            ...
                            if(notifications[i].texts[t].customColor){

                                if(notifications[i].texts[t].text != null){

                                    notifications[i].texts[t].text.color = notifications[i].texts[t].textColor;

                                }//text != null

                                if(notifications[i].texts[t].textMeshPro != null){

                                    notifications[i].texts[t].textMeshPro.color = notifications[i].texts[t].textColor;
                ...
                for(int t = 0; t < notifications[slot - 1].texts.Count; t++) {
                    ...
                    if(notifications[slot - 1].texts[t].text != null){
                        ...
                        if(notifications[slot - 1].texts[t].notification == ""){
                            ...
                            notifications[slot - 1].texts[t].text.text = texts[t];
                    ...
                    if(notifications[slot - 1].texts[t].textMeshPro != null){
                        ...
                        if(notifications[slot - 1].texts[t].notification == ""){
                            ...
                            notifications[slot - 1].texts[t].textMeshPro.text = texts[t];
