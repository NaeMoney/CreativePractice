...
namespace DizzyMedia.HFPS_Components {
    ...
    ///////////////////////////////
            ...
            if(state){
                ...
                if(actionBar != null){
                    ...
                    if(actionBarSettings.actions.Count > 0){
                        ...
                        for(int a = 0; a < actionBarSettings.actions.Count; a++) {

                            int tempInt = a;

                            actionBar.ActionTexts_Add(actionBarSettings.actions[a].text);
                            actionBar.actions[a].onActionInit.AddListener(() => ActionBar_EventInvoke(tempInt));
                    ...
                    //actions.Count > 0
                        ...
                        actionBar.ActionTexts_Add("Null");
                ...
                if(actionBar != null){
                    ...
                    if(actionBarSettings.actions.Count > 0){
                        ...
                        for(int a = 0; a < actionBarSettings.actions.Count; a++) {
                            ...
                            actionBar.ActionTexts_Remove(actionBarSettings.actions[a].text);
                            actionBar.actions[tempInt].onActionInit.RemoveAllListeners();
                    ...
                    //actions.Count > 0
                        ...
                        actionBar.ActionTexts_Remove("Null");
        ...
        private void ActionBar_EventInvoke(int slot){
            ...
            actionBarSettings.actions[slot].actionInit.Invoke();
