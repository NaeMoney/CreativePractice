    ...
    public class SceneInfoDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                musicRect.height = EditorGUIUtility.singleLineHeight;
                musicRect.y += SPACING * (4 + space);
                
                SerializedProperty m_Music = property.FindPropertyRelative("music");
                EditorGUI.PropertyField(musicRect, m_Music);
