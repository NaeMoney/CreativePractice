...
namespace HFPS.Editors
{
    ...
    public class DynamicObjectEditor : Editor
    {
        ...
        public SerializedProperty sp_useQuickAnim;
        ...
        void OnEnable()
        {
            ...
            sp_startState = serializedObject.FindProperty("startState");
        ...
        public override void OnInspectorGUI()
        {
            ...
            Start_State startState = (Start_State)sp_startState.enumValueIndex;
            ...
            if (dynamicType == Type_Dynamic.Door || dynamicType == Type_Dynamic.Drawer)
            {
                ...
                EditorGUILayout.PropertyField(sp_startState, new GUIContent("Start State"));
